...
$bas = dirname("./FacebookLogin/config.php");
require_once("$bas"."/config.php");
...
$redirectTo = "https://insomnia.surfnet.ca/IT490-2/frontEnd/FacebookLogin/callback.php";
$data = ['email'];
...
<div class="container">
  <form action="Login.php">
    <div class="row">
      ...
      <div class="col">
      <a class="fb btn" onclick="window.location = '<?php echo $fullURL ?>'">
